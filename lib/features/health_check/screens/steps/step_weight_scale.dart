      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: Colors.purple.withValues(alpha: 0.2), width: 3)),
          child:
              const Icon(Icons.scale_rounded, size: 72, color: Colors.purple),
        ),
        ...
        _buildInstructionCard(
            "Stand consistently on the platform scale.\nRemain still until the scan completes."),
            ...
            SizedBox(
              ...
              child: CircularProgressIndicator(
                ...
                color: isDone
                    ...
                    : (isStable ? AppColors.brandGreen : Colors.purple),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(isStable ? "STABLE! HOLD..." : "STABILIZING WEIGHT...",
                    style: TextStyle(
                        color: isStable
                            ? AppColors.brandGreen
  ...
  Widget _buildErrorView(HealthWizardProvider provider) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 24),
        const Text("Sensor Not Responding",
            style: TextStyle(
                fontSize: 32,
                fontWeight: FontWeight.w900,
                color: AppColors.brandDark)),
  ...
  Widget _buildInstructionCard(String text) {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          border:
              Border.all(color: Colors.purple.withValues(alpha: 0.1), width: 2),
          boxShadow: [
            BoxShadow(
