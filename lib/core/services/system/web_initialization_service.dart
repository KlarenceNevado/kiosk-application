...
class WebInitializationService {
  static final WebInitializationService _instance =
  ...
  Future<void> initialize() async {
    ...
    debugPrint(
        "🚀 [WebInitializationService] Initializing for mode: $mode (Web)");
  ...
  Future<void> _initSupabase() async {
    try {
      ...
      if (supabaseUrl == null ||
        ...
        throw Exception(
            "Missing SUPABASE_URL or SUPABASE_ANON_KEY dynamically injected");
      }
