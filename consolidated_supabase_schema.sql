-- ============================================================================
-- ISLA VERDE HEALTH SYSTEM — CONSOLIDATED PRODUCTION SCHEMA (V3.1.0)
-- ============================================================================
...
--
-- UPDATED: Integrated Zero-Knowledge Security (Hashing & Salting)
...
-- ── 2.1 Patients (UPDATED for Zero-Knowledge Architecture) ──
CREATE TABLE IF NOT EXISTS public.patients (
    ...
    pin_code TEXT, -- Legacy (encrypted/deprecated)
    pin_hash TEXT, -- NEW: SHA-256 One-Way Hash
    pin_salt TEXT, -- NEW: Unique user salt
...
ALTER TABLE public.patients ADD COLUMN IF NOT EXISTS pin_salt TEXT;
...
-- ── 2.7 System Logs (UPDATED Severity) ──
CREATE TABLE IF NOT EXISTS public.system_logs (
    ...
    severity TEXT NOT NULL, -- RELAXED: Severity check removed to allow SECURITY/LOCKOUT levels
...
-- ============================================================================
-- END OF CONSOLIDATED PRODUCTION SCHEMA V3.1.0
